...
class Options():
    ...
    def init(self,parser):
        ...
        parser.add_argument('--train_data_dir', type=str, default='Dataset/SRD/train/', help='training dataset path')
        parser.add_argument('--test_data_dir', type=str, default='Dataset/SRD/test/', help='testing dataset path')
